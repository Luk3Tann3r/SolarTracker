...
long long int integer(double value)
{
	return value;
}
...
///////////////////////////////////////////////////////////////////////////////////////////////
long double julian_day (int year, int month, int day, int hour, int minute, double second, double dut1, double tz)
{
    ...
    if(day_decimal < 0.5)
    {
        SPA_DATA.jdFraction = 1 - (0.5 - day_decimal);
        julian_day = integer(365.25*(year+4716.0)) + integer(30.6001*(month+1)) + day_decimal - 1525;
    }
    else
    {
        SPA_DATA.jdFraction = day_decimal - 0.5;
        julian_day = integer(365.25*(year+4716.0)) + integer(30.6001*(month+1)) + day_decimal - 1524;
    } 
    ...
    SPA_DATA.jdInt = (long long int)julian_day;
    return julian_day;
}
...
int spa_calculate(spa_data *spa)
{
    ...
    if (result == 0)
    {
        ...
        spa->jd = 2452930.312847;
        spa->jdInt = 2452930;          //Julian day
        spa->jdFraction = 0.312847;
        ...
        Sun.fAngleAzimuth = spa->azimuth;
        Sun.fAngleZenith = spa->zenith;
        Sun.modJulianDate = spa->jd;
    }
